  ...
  return (
    <Card className="sm:max-w-xl">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2">
            ...
            <Badge variant={menu.isPublic ? "default" : "outline"}>
              {menu.isPublic ? <Eye className="mr-2 h-4 w-4" /> : <EyeOff className="mr-2 h-4 w-4" />}
      ...
      <CardContent className="pb-4">
        <CardDescription className="max-w-lg text-balance leading-relaxed">{menu.description}</CardDescription>
      </CardContent>
