...
export default function MenuNav({ categories, openCategoryAccordions, toggleCategoryAccordion }) {
  ...
  return (
    <nav className="hidden h-full rounded-lg bg-muted/40 p-6 text-base text-muted-foreground md:block">
      <div className="grid gap-2">
        <Link href="#details" onClick={(e) => handleLinkClick(e, "details")} className="py-1 text-base">
          Details
        </Link>

        <Link href="#categories" className="py-1 text-base" onClick={(e) => handleLinkClick(e, "categories")}>
          Categories
        </Link>
        <div className="ml-2">
          <Accordion
        ...
        <Link href="#footer" onClick={(e) => handleLinkClick(e, "footer")} className="mt-2 py-1 text-base">
          Menu Footer
        </Link>
      </div>
    </nav>
