...
export default function MenuForm({ form, openCategoryAccordions, toggleCategoryAccordion }) {
  ...
  return (
    <>
      <Form {...form}>
        <form id="menu-form" onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6 overflow-y-auto">
