  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button variant={menu.isPublic ? "secondary" : "default"}>{menu.isPublic ? "Un-Publish" : "Publish"}</Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>{menu.isPublic ? "Make Private?" : "Publish Menu?"}</AlertDialogTitle>
          <AlertDialogDescription>
            {menu.isPublic
